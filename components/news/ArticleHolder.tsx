...
const ArticleHolder: FC<ArticleHolderProps> = ({
  ...
  return (
    <div id={id} className={`flex flex-col ${className}`} style={otherStyles}>
      ...
      {/* Article holder */}
      <div className={`flex-1 max-h-[calc(100lvh-9rem)]`}>
        {/* Content holder */}
        <div
          className={`grid grid-rows-1 lg:grid-cols-[3fr_1fr] gap-3 max-h-[calc(100lvh-9rem)]`}
        >
          {/* Carousel holder */}
          <div
            className={`bg-[#303030] rounded flex flex-col overflow-hidden max-h-[calc(100lvh-9rem)]`}
          >
            <div
              className={`flex-1 flex flex-col justify-between rounded max-h-[calc(100lvh-9rem)]`}
            >
              <Slider tabIndex={-1}>
                ...
                <Slide
                  index={0}
                  tabIndex={-1}
                  className={`article-content-holder p-4 text-white overflow-y-auto bg-scroll bg-no-repeat bg-cover bg-center min-h-[calc(100lvh-21rem)] lg:min-h-[calc(100lvh-12rem)]`}
                  style={{
                ...
                <Slide
                  index={1}
                  tabIndex={-1}
                  className={`article-content-holder p-4 text-white overflow-y-auto min-h-[calc(100lvh-21rem)] lg:min-h-[calc(100lvh-12rem)]`}
                >
