...
const ArticleHolder: FC<ArticleHolderProps> = ({
  ...
  return (
    <div id={id} className={`flex flex-col ${className}`} style={otherStyles}>
      ...
      <div
        className={`flex-1 ${
          isInPwaMode ? "max-h-[calc(100vh-9rem)]" : "max-h-[calc(100dvh-9rem)]"
        }`}
      >
        {/* Content holder */}
        <div
              ...
              <Slider tabIndex={-1}>
                ...
                <Slide
                  ...
                  className={`article-content-holder p-4 text-white overflow-y-auto bg-scroll bg-no-repeat bg-cover bg-center ${
                    isInPwaMode
                      ? "min-h-[calc(100vh-21rem)] lg:min-h-[calc(100vh-12rem)]"
                      : "min-h-[calc(100dvh-21rem)] lg:min-h-[calc(100dvh-12rem)]"
                  }`}
                  style={{
