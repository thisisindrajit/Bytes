  ...
  return (
    <div id={id} className={`flex flex-col ${className}`} style={otherStyles}>
      ...
      <div className={`flex-1 max-h-[calc(100dvh-9rem)]`}>
        {/* Content holder */}
        <div
          className={`grid grid-rows-1 lg:grid-cols-[3fr_1fr] gap-3 max-h-[calc(100dvh-9rem)]`}
        >
          {/* Carousel holder */}
          <div
            className={`bg-[#303030] rounded flex flex-col overflow-hidden max-h-[calc(100dvh-9rem)]`}
          >
            <div
              className={`flex-1 flex flex-col justify-between rounded max-h-[calc(100dvh-9rem)]`}
            >
              <Slider tabIndex={-1}>
